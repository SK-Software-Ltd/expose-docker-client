...
return [
    ...
    */
    'servers' => [
        'main' => [
            'host' => $_SERVER['EXPOSE_SERVER_HOST'],
            'port' => $_SERVER['EXPOSE_SERVER_PORT'] ?? 443,
        ],
    ],
    ...
    |
    */
    'server_endpoint' => $_SERVER['EXPOSE_SERVER_SCHEME'].'://'.$_SERVER['EXPOSE_SERVER_HOST'].'/api/servers',
    ...
    */
    ...
    |
    */
    'auth_token' => $_SERVER['EXPOSE_AUTH_TOKEN'],
    ...
    |
    */
    'default_domain' => $_SERVER['EXPOSE_SERVER_HOST'],
    ...
    */
    ...
    'platform_url' => $_SERVER['EXPOSE_SERVER_SCHEME'].'://'.$_SERVER['EXPOSE_SERVER_HOST'],
